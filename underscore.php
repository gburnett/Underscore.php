...
class __ {
  ...
  public function union($array=null) {
    ...
    $__ = new self;
    return self::_wrap(array_values(array_map('unserialize',array_unique(array_map('serialize',call_user_func_array('array_merge', $arrays))))));
  }
  ...
  public function indexBy($collection=null, $iterator=null, $context=null) {
    list($collection, $iterator, $context) = self::_wrapArgs(func_get_args(), 3);
    $iterator = self::_bindContext($iterator, $context);
